...
public class HibernateConfig {
    ...
    private static final String dbName = "PlantShopService";
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        configuration.addAnnotatedClass(org.example.model.Plant.class);
        configuration.addAnnotatedClass(org.example.model.Reseller.class);
    }
